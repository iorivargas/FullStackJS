...
const NuevaCita = (props) => {
    ...
    const actualizarState = e =>{
        // console.log(e.target.name); permite saber que input se esta modificando 
        // console.log(e.target.value); permite saber cuando se modifica el input en tiempo real
        guardarCita({
            ...cita,
                ...
                <form 
                    ...
                    <div className="form-group">
                        ...
                        <input 
                            ...
                            onChange={actualizarState} //permite saber cuando cambia el input y manda llamar a la funcion actualizar state
                        />
                    </div>
